        ...
        return (
            <div class='profilecontainer' style={{ marginTop: '15%' }}>
                <div class='profile card'>
                    <img class='profile image' src={`data:image/png;base64,${avatar}`} alt='Profile' />
                    <p class='profile name'>{user.name}</p>
                    <p class='profile bio'>{user.email}</p>

                    <div class='stats'>
                        <div class='stat'>
                            <p class='number'>{user.favorites.length}</p>
                            <p class='title'>Favorite Recipes</p>
                        </div>
                        <div class='stat'>
                            <p class='number'>{user.recipes.length}</p>
